      ...
      <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
          <div>
            ...
            <p>
              ...
              <a
                href="#"
                className="block text-2xl font-medium dark:text-gray-300 text-gray-900 hover:opacity-75 sm:text-3xl"
              >
                0123456789
              </a>
            </p>

            <ul className="mt-8 space-y-1 text-sm dark:text-gray-200 text-gray-700">
              <li>Od poniedziałku do piątku: 9-17</li>
            </ul>
            ...
            <ul className="flex gap-6 mt-8">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className=" dark:text-gray-200 text-gray-700 transition hover:opacity-75"
                >
        ...
        <div className="pt-12 mt-12 border-t border-gray-100">
          <div className="sm:flex sm:items-center sm:justify-between">
            <nav aria-label="Footer Navigation - Support">
              <ul className="flex flex-wrap gap-4 text-xs">
                <li>
                  <a
                    href="#"
                    className="dark:text-gray-200 text-gray-500 transition hover:opacity-75"
                  >
                    Regulamin
                  </a>
                </li>
            ...
            <p className="dark:text-gray-200 mt-8 text-xs text-gray-500 sm:mt-0">
